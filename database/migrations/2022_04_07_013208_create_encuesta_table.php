...
class CreateEncuestaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('encuesta', function (Blueprint $table) {
            ...
            $table->string("p1_a", 2)->nullable();
            $table->string("p1_b", 2)->nullable();
            $table->string("p1_c", 2)->nullable();
            $table->string("p1_d", 2)->nullable();
            $table->string("p1_e", 2)->nullable();
            $table->string("p1_f", 2)->nullable();
            $table->integer("p2_a")->nullable();
            $table->integer("p2_c")->nullable();
            $table->integer("p2_d")->nullable();
            $table->integer("p2_e")->nullable();
            $table->integer("p2_f")->nullable();
            $table->integer("p2_g")->nullable();
            $table->integer("p2_h")->nullable();
            $table->integer("p2_i")->nullable();
            $table->integer("p2_j")->nullable();
            $table->integer("p2_k")->nullable();
